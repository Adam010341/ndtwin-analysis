// NDTwin progress report, 2026-09-03. Twenty-three pages, three sections.
//
...
const FIG = HERE + "/../figures/";
const HIRES = HERE + "/../figures/_hires/";      // fig5–8, rasterised from PDF
const OUT = HERE + "/../NDTwin_deck_903.pptx";
